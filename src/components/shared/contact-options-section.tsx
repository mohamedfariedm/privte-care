...
export function ContactOptionsSection() {
  ...
  return (
    <section className="section-border-y md:h-[281px]">
      <div className="container-page grid md:h-full md:grid-cols-3">
        {options.map((option) => (
          <article
            key={option.key}
            className="flex flex-col items-center justify-center gap-6 border-border-muted-2 px-6 py-10 text-center md:h-full md:border-x md:px-10 md:py-6 md:first:border-s-0 md:last:border-e-0"
          >
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="font-serif text-sm leading-[26px] text-text-default">
